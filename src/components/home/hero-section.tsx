...
export function HeroSection({ brand, title, subtitle, cta }: Props) {
  return (
    <section className="relative isolate min-h-[calc(100svh-3.25rem)] overflow-hidden">
      <HeroStage />
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-3.25rem)] w-full max-w-6xl flex-col justify-end px-6 pt-24 pb-16 md:justify-center md:pb-24">
