      ...
      >
        ...
        >
          <div className="flex shrink-0 flex-col gap-1.5">
            <LabelWithHint
              label={t("catalogBrowse.label")}
              hint={t("catalogBrowse.hint")}
              hintLabel={t("catalogBrowse.hintLabel")}
            />
            <TabsList
              variant="default"
              className="h-auto w-full min-w-0 flex-col items-stretch justify-start gap-0.5 overflow-hidden p-1"
              aria-label={t("catalogBrowse.label")}
            >
